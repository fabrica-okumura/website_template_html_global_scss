...
<head>
  ...
  <meta name="description" content="そのページ内容を説明するテキストを設定します。">
  <meta property="og:title" content="<?php echo $site_title; ?>">
  <meta property="og:description" content="そのページ内容を説明するテキストを設定します。">
  ...
  <meta property="og:type" content="<?php echo $page == "home" ? "website" : "article"; ?>">

  <meta property="og:url" content="ページのURLを出力してください">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:image" content="<?php echo $base_url; ?>/img/ogp_large.png">
  <meta property="og:image" content="<?php echo $base_url; ?>/img/ogp_large.png">
